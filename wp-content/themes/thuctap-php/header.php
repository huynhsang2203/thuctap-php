...
<body <?php body_class(); ?>>
    <!-- HEADER -->
    <header>
        <img src="<?php bloginfo('stylesheet_directory') ?>/assets/image/header.svg" alt="header">
        ...
        <div class="nav-tags">
            <div class="nav-tags tags-phone">
                ...
                <div class="tags-phone phone-svg">
                    <img src="<?php bloginfo('stylesheet_directory') ?>/assets/image/icon-phone.svg" alt="icon-phone">
                </div>
            </div>
            <div class="tags-3">
                <?php wp_nav_menu( 
