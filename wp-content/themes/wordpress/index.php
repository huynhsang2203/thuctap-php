...
<body>
	<?php get_template_part( 'background');?>
	<div class="image3">
		<img src="<?php bloginfo( 'stylesheet_directory'); ?>/assets/image/image3.png" alt="image3">
	</div>
	...
	<!-- ảnh hoa sen -->
	<div class="hoa-sen">
		<img src="<?php bloginfo( 'stylesheet_directory'); ?>/assets/image/hoasen.png" alt="hoasen">
	</div>
	...
	<div class="image2">
		<img src="<?php bloginfo( 'stylesheet_directory'); ?>/assets/image/image2.png" alt="image2">
	</div>

	<div class="image4">
		<img src="<?php bloginfo( 'stylesheet_directory'); ?>/assets/image/image4.png" alt="image4">
	</div>

	<div class="image6">
		<img src="<?php bloginfo( 'stylesheet_directory'); ?>/assets/image/image6.png" alt="image6">
	</div>
